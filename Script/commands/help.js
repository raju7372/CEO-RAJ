...
const first = numberOfOnePage * page - numberOfOnePage;
   ...
   for (let cmds of helpView) msg += `•—»[ ${cmds} ]«—•\n`;
    const siu = `╭──────•◈•──────╮\n |        𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁 \n |   🄲🄾🄼🄼🄰🄽🄳 🄻🄸🅂🅃       \n╰──────•◈•──────╯`;
const text = `╭──────•◈•──────╮\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │ 𝙁𝘼𝙃𝙄𝙈 𝘼𝙃𝙈𝙀𝘿 ッ\n│𝗧𝗢𝗧𝗔𝗟 : [${arrayInfo.length}]\n│📛🄿🄰🄶🄴📛 :  [${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}]\n╰──────•◈•──────╯`; 
    var link = [
"https://i.imgur.com/JLlKYSw.jpeg", "https://i.imgur.com/XbbhwUz.jpeg", "https://i.imgur.com/J53QBu4.jpeg", "https://i.imgur.com/k8AhY1C.jpeg",
"https://i.imgur.com/Xx0pRP1.jpeg",
"https://i.imgur.com/brZF9WU.jpeg",
"https://i.imgur.com/sum0pvc.jpeg",
    ]
