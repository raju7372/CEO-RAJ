...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    const fs = require("fs");
    return api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ 𝙁𝘼𝙃𝙄𝙈 এঁরঁ ─꯭─⃝‌‌𝙃𝙖𝙘𝙠𝙖𝙧 𝘽𝙤𝙩 𝙄𝙨𝙧𝙖𝙩 এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..! ", event.threadID, () => api.sendMessage({body:`╔════•| ✿ |•════╗\nআ্ঁস্ঁসা্ঁলা্ঁমু্ঁ💚আ্ঁলা্ঁই্ঁকু্ঁম্ঁ\n╚════•| ✿ |•════╝
...
________________________\n★যে্ঁকো্ঁনো্ঁ অ্ঁভি্ঁযো্ঁগ্ঁ অ্ঁথ্ঁবা্ৃ হে্ঁল্প্ঁ এ্ঁর্ঁ জ্ঁন্য্ঁ এ্ঁড্ঁমি্ঁন্ঁ 𝙁𝘼𝙃𝙄𝙈 কে্ঁ ন্ঁক্ঁ ক্ঁর্ঁতে্ঁ পা্ঁরে্ঁন্ঁ★\n𝐌𝐞𝐬𝐬𝐞𝐠𝐞𝐫:  𝙃𝙏𝙏𝙋𝙎://𝙈.𝙈𝙀/𝙃𝘼𝘾𝙆𝘼𝙍.𝙑𝘼𝙄𝙔𝘼\n𝐈𝐦𝐨 𝐎𝐫 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: 01771240377
\n⋆✦⎯⎯⎯⎯⎯⎯⎯⎯✦⋆\n𝐂𝐫𝐞𝐚𝐭𝐨𝐫 ➢ 𝙁𝙖𝙝𝙞𝙢 𝘼𝙝𝙢𝙚𝙙`, attachment: fs.createReadStream(__dirname + "/Nazrul/join.jpeg")} ,threadID));
  }
  else {
    try {
